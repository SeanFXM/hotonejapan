...
type Section = "concept" | "control" | "specs"
...
export default function BassPressPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative w-full h-[600px] overflow-hidden">
        <Image
          src="/images/brands/hotone/BASS_PRESS/hero.jpg"
          alt="BASS PRESS"
          fill
          ...
          <div className="bg-white/70 backdrop-blur-md p-6 rounded-xl shadow-2xl border border-white/30 w-96">
            ...
            <div className="space-y-4 text-gray-900">
              <div className="border-b border-gray-200 pb-3">
                ...
                <p className="text-2xl font-bold text-gray-900">BASS PRESS</p>
              </div>
              ...
              <div className="border-b border-gray-200 pb-3">
                ...
                <p className="text-xl font-bold text-hotone">¥11,000</p>
                <p className="text-xs text-gray-500">前後（税込）</p>
              </div>

              <div className="border-b border-gray-200 pb-3">
                <p className="text-xs text-gray-500 mb-1">JAN：</p>
                <p className="text-sm font-mono text-gray-700">6959473904022</p>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div>
              <div className="rounded-2xl overflow-hidden shadow-lg bg-gray-200 p-8">
                <Image
                  src="/images/brands/hotone/BASS_PRESS/intro.jpg"
                  alt="BASS PRESS"
                  width={600}
                  height={400}
            ...
            <div className="space-y-6">
              <p className="text-gray-700 leading-relaxed">
                ボイジングをベースの帯域に下げたベース専用ワウを搭載。SOUL PRESS同様、WAH & VOL & EXP の３機能を詰め込みました。スライドスイッチ一発で３機能が切り替えられます。ペダルボードに固定してからも、出力ジャックの抜き差しせずに、Vol とWah の切替が可能です。
              </p>
          ...
          <div className="max-w-5xl mx-auto space-y-12">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
              <div className="flex justify-center">
                <Image
                  src="/images/brands/hotone/BASS_PRESS/control_01.png"
                  alt="Control 1"
                  width={400}
                  height={300}
            ...
            <div className="flex justify-center">
              <Image
                src="/images/brands/hotone/BASS_PRESS/control_02.png"
                alt="Control 2"
                width={500}
                height={400}
