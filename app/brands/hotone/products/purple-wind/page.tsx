  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative w-full h-[600px] overflow-hidden">
        <Image
          src="/images/brands/hotone/Purple_Wind/hero.jpg"
          alt="Purple Wind"
          fill
          ...
          <div className="bg-white/70 backdrop-blur-md p-6 rounded-xl shadow-2xl border border-white/30 w-96">
            ...
            <div className="space-y-4 text-gray-900">
              <div className="border-b border-gray-200 pb-3">
                ...
                <p className="text-2xl font-bold text-gray-900">Purple Wind</p>
              </div>
              ...
              <div className="pt-2">
                ...
                <p className="text-sm font-mono text-gray-700">6959473901021</p>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <div className="rounded-2xl overflow-hidden">
                <Image
                  src="/images/brands/hotone/Purple_Wind/intro.jpg"
                  alt="Purple Wind"
                  width={600}
                  height={400}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="aspect-video rounded-2xl overflow-hidden shadow-2xl">
                <iframe
                  width="100%"
                  height="100%"
                  src="https://www.youtube.com/embed/D77acuCyW2c"
                  title="Purple Wind Demo 1"
                  frameBorder="0"
          ...
          <div className="max-w-md mx-auto">
            <div className="bg-white rounded-xl shadow-md p-5">
              <div className="flex items-center gap-3 mb-3">
                ...
                <p className="font-medium text-gray-900 text-sm">Purple Wind Overview Demo</p>
              </div>
              <audio controls className="w-full h-10">
                <source src="/images/brands/hotone/Purple_Wind/sound_01.mp3" type="audio/mpeg" />
              </audio>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-5xl mx-auto">
            <div className="bg-white rounded-2xl p-8">
              <div className="space-y-8">
                <div>
                  <Image
                    src="/images/brands/hotone/Purple_Wind/control_01.png"
                    alt="Purple Wind Top Panel"
                    width={1000}
                    height={400}
                ...
                <div className="border-t border-gray-200 pt-8">
                  <Image
                    src="/images/brands/hotone/Purple_Wind/control_02.png"
                    alt="Purple Wind Back Panel"
                    width={1000}
                    height={400}
                    className="w-full h-auto rounded-lg"
                  />
