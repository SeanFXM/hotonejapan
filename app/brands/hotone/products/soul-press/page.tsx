...
export default function SoulPressPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative w-full h-[600px] overflow-hidden">
        <Image
          src="/images/brands/hotone/SOUL_PRESS/hero.jpg"
          alt="SOUL PRESS"
          fill
          ...
          <div className="bg-white/70 backdrop-blur-md p-6 rounded-xl shadow-2xl border border-white/30 w-96">
            ...
            <div className="space-y-4 text-gray-900">
              <div className="border-b border-gray-200 pb-3">
                ...
                <p className="text-2xl font-bold text-gray-900">SOUL PRESS</p>
              </div>
              ...
              <div className="border-b border-gray-200 pb-3">
                ...
                <p className="text-sm font-mono text-gray-700">6959473904015</p>
              </div>
      ...
      <section id="concept" className="py-20 scroll-mt-24 bg-gray-100">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">欲張り３in１フットペダル</p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div>
              <div className="rounded-2xl overflow-hidden shadow-lg bg-gray-200 p-8">
                <Image
                  src="/images/brands/hotone/SOUL_PRESS/intro.jpg"
                  alt="SOUL PRESS"
                  width={600}
                  height={400}
            ...
            <div className="space-y-6">
              <p className="text-gray-700 leading-relaxed">
                ペダルボードの救世主SOUL PRESS、堂々の登場です。 ペダルボード内で、最も大きな顔をしたVol やWah ペダルを最小化しました。なんと、一般的なフットペダルの約1/2 サイズ。その中に、WAH & VOL & EXP の３機能を 詰め込みました。スライドスイッチ一発で３機能が切り替えられます。ペダルボードに 固定してからも、出力ジャックのを抜き差しせずに、Vol とWah の切替が可能です。
              </p>
              <p className="text-gray-700 leading-relaxed">
                システムの構築や用途に合わせて、最適な機能が選べる「カメレオンペダル」。赤くかわいいサイズに、ギタリストが慣れ親しんだ"CryBaby" wah と同じ『践み込み角度』 の採用も嬉しいこだわりです。
              </p>
              <ul className="space-y-2 text-gray-700">
                ...
                <li className="flex items-start gap-2">
                  <span className="text-green-600 mt-1">✓</span>
                  <span>ボリューム / エクスプレッション / ワウの３モードの選択が可能</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-600 mt-1">✓</span>
                ...
                <li className="flex items-start gap-2">
                  <span className="text-green-600 mt-1">✓</span>
                  <span>ボトムレンジの調整が可能（エクスプレッション、ボリューム・モードのみ）</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-600 mt-1">✓</span>
          ...
          <div className="max-w-3xl mx-auto">
            <div className="rounded-xl overflow-hidden shadow-lg">
              <iframe
                width="100%"
                height="400"
                src="https://www.youtube.com/embed/0utLiOoc5nc"
                title="SOUL PRESS Demo"
                frameBorder="0"
            ...
            <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
              <div className="space-y-4">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-base font-bold text-gray-900">SOUL PRESS Overview Demo</span>
                </div>
                <audio controls className="w-full">
                  <source src="/images/brands/hotone/SOUL_PRESS/sound_01.mp3" type="audio/mpeg" />
          ...
          <div className="max-w-5xl mx-auto space-y-12">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
              <div className="flex justify-center">
                <Image
                  src="/images/brands/hotone/SOUL_PRESS/control_01.png"
                  alt="Control 1"
                  width={400}
                  height={300}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-700">
                      モードにより、オーディオ出力とエクスプレッション・アウトが兼用です。エクスプレッション・ペダルとして使用する場合は、1/4 フォーンのステレオケーブル（TRSケーブル）を用いて任意の機器に接続してください。（ロー・インピーダンス）
                    </p>
                  </div>
                  <div>
                    <h4 className="inline-flex items-center gap-1 text-sm font-bold text-gray-900 bg-gray-200 px-2 py-1 rounded mb-2">
                    ...
                    <p className="text-xs text-gray-500 mt-2">
                      注1：EXP モードで使用する場合は、電源に接続する必要はありません。もしペダルが動作しない場合はフットスイッチを押し、再度お試しください（電源を接続していない場合、LED は点灯しません）。
                    </p>
                  </div>
                </div>
                {/* Right Column */}
                <div className="space-y-4">
                  <div>
                    ...
                    <ul className="text-sm text-gray-700 space-y-1">
                      ...
                      <li><span className="font-medium">≡ EXP</span><br />エクスプレッション・ペダルモード</li>
                    </ul>
                  </div>
                  <div>
                    <h4 className="inline-flex items-center gap-1 text-sm font-bold text-gray-900 bg-gray-200 px-2 py-1 rounded mb-2">
                    ...
                    <p className="text-sm text-gray-700">
                      ボリューム・ペダル、エクスプレッション・ペダルの可変幅を設定します。範囲は、0％～100％…50％～100％の間で設定可能です。
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="flex justify-center">
              <Image
                src="/images/brands/hotone/SOUL_PRESS/control_02.png"
                alt="Control 2"
                width={500}
                height={400}
