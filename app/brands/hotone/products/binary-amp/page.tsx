...
export default function BinaryAmpPage() {
  ...
  const handleManualDownload = () => {
    downloadManual("hotone", "binary-amp")
  }
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative w-full h-[600px] overflow-hidden">
        <Image
          src="/images/brands/hotone/BINARY_AMP/hero.jpg"
          alt="BINARY AMP"
          fill
          ...
          <div className="bg-white/70 backdrop-blur-md p-6 rounded-xl shadow-2xl border border-white/30 w-96">
            ...
            <div className="space-y-4 text-gray-900">
              <div className="border-b border-gray-200 pb-3">
                ...
                <p className="text-2xl font-bold text-gray-900">BINARY AMP</p>
              </div>

              <div className="border-b border-gray-200 pb-3">
                <p className="text-xs text-gray-500 mb-1">概要：</p>
                <p className="text-base text-gray-900">アンプ・シミュレーター</p>
              </div>
              ...
              <div className="pt-2">
                ...
                <p className="text-sm font-mono text-gray-700">6959473910016</p>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="space-y-6">
              <div className="rounded-2xl overflow-hidden shadow-2xl">
                <Image
                  src="/images/brands/hotone/BINARY_AMP/intro.jpg"
                  alt="Binary Amp"
                  width={600}
                  height={400}
              ...
              <div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <p className="text-gray-700 text-sm">伝説のアンプを再現した16種のCDCMエミュレーション（on/off可能なキャビネットモデリング）</p>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <p className="text-gray-700 text-sm">エフェクトループ</p>
                  </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                ...
                <div className="aspect-video bg-black rounded-2xl overflow-hidden shadow-2xl">
                  <iframe
                    width="100%"
                    height="100%"
                    src="https://www.youtube.com/embed/qt29E3WZ_m0"
                    title="Hotone Binary AMP - CDCM Amplifier Simulator"
                    frameBorder="0"
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="aspect-video bg-black rounded-2xl overflow-hidden shadow-2xl">
                  <iframe
                    width="100%"
                    height="100%"
                    src="https://www.youtube.com/embed/yVy0xmhnvtM"
                    title="BINARY AMP Demo 3"
                    frameBorder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                    allowFullScreen
                    className="w-full h-full"
          ...
          <div className="container mx-auto px-6">
            ...
            <div className="max-w-4xl mx-auto space-y-12">
              <div className="flex justify-center">
                <Image
                  src="/images/brands/hotone/BINARY_AMP/control_01.png"
                  alt="BINARY AMP Top Panel"
                  width={800}
                  height={400}
              ...
              <div className="flex justify-center">
                <Image
                  src="/images/brands/hotone/BINARY_AMP/control_02.png"
                  alt="BINARY AMP Back Panel"
                  width={800}
                  height={400}
                  className="rounded-lg w-full"
                />
            ...
            <div className="max-w-5xl mx-auto">
              <div className="bg-gray-100 rounded-xl p-8">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                  ...
                  <div>
                    <Image
                      src="/images/brands/hotone/BINARY_AMP/software_01.jpg"
                      alt="Binary Editor"
                      width={600}
                      height={400}
                  ...
                  <div className="space-y-4">
                    {/* BINARY EDITOR */}
                    <h3 className="text-2xl font-bold text-gray-900">BINARY EDITOR（Mac / Win）</h3>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-16 gap-y-8">
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-gray-700 text-sm">エフェクト・センド・リターン</p>
                  ...
                  <div className="space-y-8">
                    ...
                    <div>
                      ...
                      <div className="space-y-2">
                        <p className="text-gray-700 text-sm">搭載エフェクト数：16</p>
