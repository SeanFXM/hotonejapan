...
export default function MojoAttackPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative w-full h-[600px] overflow-hidden">
        <Image
          src="/images/brands/hotone/MOJO_ATTACK/hero.jpg"
          alt="MOJO ATTACK"
          fill
          ...
          <div className="bg-white/70 backdrop-blur-md p-6 rounded-xl shadow-2xl border border-white/30 w-96">
            ...
            <div className="space-y-4 text-gray-900">
              <div className="border-b border-gray-200 pb-3">
                ...
                <p className="text-2xl font-bold text-gray-900">MOJO ATTACK</p>
              </div>
              ...
              <div className="border-b border-gray-200 pb-3">
                ...
                <p className="text-xl font-bold text-hotone">¥37,950</p>
                <p className="text-xs text-gray-500">前後（税込）</p>
              </div>

              <div className="border-b border-gray-200 pb-3">
                <p className="text-xs text-gray-500 mb-1">JAN：</p>
                <p className="text-sm font-mono text-gray-700">6959473901212</p>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div>
              <div className="rounded-2xl overflow-hidden">
                <Image
                  src="/images/brands/hotone/MOJO_ATTACK/intro.jpg"
                  alt="MOJO ATTACK"
                  width={600}
                  height={400}
              ...
              <div className="mt-8 pt-6 border-t border-gray-300">
                ...
                <div className="space-y-2">
                  <a href="/brands/hotone/products/britwind" className="flex items-center gap-2 text-gray-700 hover:text-purple-600 transition-colors">
            ...
            <div className="space-y-6">
              ...
              <p className="text-gray-500 text-xs leading-relaxed">
                ※本製品以外の製品名及び会社名は、各社の商号、登録商標又は商標です。本文中で使用している名称は、音色の傾向をお伝えする目的で使用しております。
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-6xl mx-auto space-y-6">
            ...
            <div className="aspect-video rounded-2xl overflow-hidden shadow-2xl">
              <iframe
                width="100%"
                height="100%"
                src="https://www.youtube.com/embed/7YPQTPv0LGA"
                title="MOJO ATTACK Demo 1"
                frameBorder="0"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              <div className="bg-white rounded-xl shadow-md p-4">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <p className="font-medium text-gray-900 text-sm">MOJO ATTACK（CH.B）Intro</p>
                </div>
                <audio controls className="w-full h-10">
                  <source src="/images/brands/hotone/MOJO_ATTACK/sound_1.mp3" type="audio/mpeg" />
                </audio>
              </div>
              <div className="bg-white rounded-xl shadow-md p-4">
                <div className="flex items-center gap-3 mb-3">
                  <span className="text-lg">🎵</span>
                  <p className="font-medium text-gray-900 text-sm">MOJO ATTACK（CH.A）01</p>
                </div>
                <audio controls className="w-full h-10">
                  <source src="/images/brands/hotone/MOJO_ATTACK/sound_2.mp3" type="audio/mpeg" />
                </audio>
              </div>
              <div className="bg-white rounded-xl shadow-md p-4">
                <div className="flex items-center gap-3 mb-3">
                  <span className="text-lg">🎵</span>
                  <p className="font-medium text-gray-900 text-sm">MOJO ATTACK（CH.A with Boost）02</p>
                </div>
                <audio controls className="w-full h-10">
                  <source src="/images/brands/hotone/MOJO_ATTACK/sound_3.mp3" type="audio/mpeg" />
                </audio>
              </div>
              <div className="bg-white rounded-xl shadow-md p-4">
                <div className="flex items-center gap-3 mb-3">
                  <span className="text-lg">🎵</span>
                  <p className="font-medium text-gray-900 text-sm">MOJO ATTACK（CH.B）03</p>
                </div>
                <audio controls className="w-full h-10">
                  <source src="/images/brands/hotone/MOJO_ATTACK/sound_4.mp3" type="audio/mpeg" />
                </audio>
              </div>
              <div className="bg-white rounded-xl shadow-md p-4">
                <div className="flex items-center gap-3 mb-3">
                  <span className="text-lg">🎵</span>
                  <p className="font-medium text-gray-900 text-sm">MOJO ATTACK（CH.B with Reverb）04</p>
                </div>
                <audio controls className="w-full h-10">
                  <source src="/images/brands/hotone/MOJO_ATTACK/sound_5.mp3" type="audio/mpeg" />
                </audio>
              </div>
              <div className="bg-white rounded-xl shadow-md p-4">
                <div className="flex items-center gap-3 mb-3">
                  <span className="text-lg">🎵</span>
                  <p className="font-medium text-gray-900 text-sm">MOJO ATTACK（CH.A）05</p>
                </div>
                <audio controls className="w-full h-10">
                  <source src="/images/brands/hotone/MOJO_ATTACK/sound_6.mp3" type="audio/mpeg" />
                </audio>
              </div>
              <div className="bg-white rounded-xl shadow-md p-4">
                <div className="flex items-center gap-3 mb-3">
                  <span className="text-lg">🎵</span>
                  <p className="font-medium text-gray-900 text-sm">MOJO ATTACK（CH.A）06</p>
                </div>
                <audio controls className="w-full h-10">
                  <source src="/images/brands/hotone/MOJO_ATTACK/sound_7.mp3" type="audio/mpeg" />
                </audio>
              </div>
              <div className="bg-white rounded-xl shadow-md p-4">
                <div className="flex items-center gap-3 mb-3">
                  <span className="text-lg">🎵</span>
                  <p className="font-medium text-gray-900 text-sm">MOJO ATTACK（CH.B）07</p>
                </div>
                <audio controls className="w-full h-10">
                  <source src="/images/brands/hotone/MOJO_ATTACK/sound_8.mp3" type="audio/mpeg" />
                </audio>
              </div>
              <div className="bg-white rounded-xl shadow-md p-4">
                <div className="flex items-center gap-3 mb-3">
                  <span className="text-lg">🎵</span>
                  <p className="font-medium text-gray-900 text-sm">MOJO ATTACK（CH.B）08</p>
                </div>
                <audio controls className="w-full h-10">
                  <source src="/images/brands/hotone/MOJO_ATTACK/sound_9.mp3" type="audio/mpeg" />
                </audio>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-5xl mx-auto">
            <div className="bg-white rounded-2xl p-8">
              <div className="space-y-8">
                <div>
                  <Image
                    src="/images/brands/hotone/MOJO_ATTACK/control_01.png"
                    alt="MOJO ATTACK Top Panel"
                    width={1000}
                    height={400}
                ...
                <div className="border-t border-gray-200 pt-8">
                  <Image
                    src="/images/brands/hotone/MOJO_ATTACK/control_02.png"
                    alt="MOJO ATTACK Back Panel"
                    width={1000}
                    height={400}
                    className="w-full h-auto rounded-lg"
                  />
      ...
      <section id="connections" className="py-20 scroll-mt-24 bg-gray-100">
        <div className="container mx-auto px-6">
          ...
          <div className="max-w-5xl mx-auto">
            <Image
              src="/images/brands/hotone/MOJO_ATTACK/connection_01.png"
              alt="MOJO ATTACK Connection Example"
              width={1200}
              height={600}
              className="w-full h-auto"
            />
