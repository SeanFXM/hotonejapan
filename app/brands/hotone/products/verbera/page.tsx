...
type Section = "concept" | "demo" | "samples" | "controls" | "connections" | "software" | "specs" | "manual"

const navigationItems = [
  { id: "concept" as Section, label: "コンセプト" },
  { id: "demo" as Section, label: "デモムービー" },
  { id: "samples" as Section, label: "サンプルサウンド" },
...
export default function VerberaPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative w-full h-[600px] overflow-hidden">
        <Image
          src="/images/brands/hotone/verbera/hero.jpg"
          alt="Verbera Convolution Reverb"
          fill
          ...
          <div className="bg-white/70 backdrop-blur-md p-6 rounded-xl shadow-2xl border border-white/30 w-96">
            ...
            <div className="space-y-4 text-gray-900">
              <div className="border-b border-gray-200 pb-3">
                ...
                <p className="text-2xl font-bold text-gray-900">VERBERA</p>
              </div>
      ...
      {/* Concept Section - Top Part with Video */}
          ...
          <div className="space-y-20 max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="order-2 lg:order-1">
                <div className="relative w-full aspect-[16/10]">
                  <Image
                    src="/images/brands/hotone/verbera/concept-01.jpg"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                <div className="relative w-full aspect-[16/10]">
                  <Image
                    src="/images/brands/hotone/verbera/concept-02.jpg"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="order-2 lg:order-1">
                <div className="relative w-full aspect-[16/10]">
                  <Image
                    src="/images/brands/hotone/verbera/concept-03.jpg"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                <div className="relative w-full aspect-[16/10]">
                  <Image
                    src="/images/brands/hotone/verbera/concept-04.jpg"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="order-2 lg:order-1">
                <div className="relative w-full aspect-[16/10]">
                  <Image
                    src="/images/brands/hotone/verbera/concept-05.jpg"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                <div className="relative w-full aspect-[16/10]">
                  <Image
                    src="/images/brands/hotone/verbera/concept-06.jpg"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="order-2 lg:order-1">
                <div className="relative w-full aspect-[16/10]">
                  <Image
                    src="/images/brands/hotone/verbera/concept-07.jpg"
      ...
      <div className="bg-gray-50">
        ...
        <section id="samples" className="py-20 scroll-mt-24 bg-gray-50">
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
          ...
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <div className="flex justify-center">
                <div className="w-20 h-1 rounded" style={{ backgroundColor: "#22c55e" }} />
              </div>
            </div>
            ...
            <div className="max-w-7xl mx-auto space-y-16">
              <div className="flex justify-center mb-16">
                <div className="relative w-full max-w-2xl">
                  <Image
                    src="/images/brands/hotone/verbera/control_1.png"
                    alt="Verbera Controls - Front"
                    width={800}
                    height={900}
              ...
              <div className="mt-20">
                <div className="flex justify-center mb-12">
                  <div className="relative w-full max-w-2xl">
                    <Image
                      src="/images/brands/hotone/verbera/control_2.png"
        ...
        {/* Connections Section */}
        <section id="connections" className="py-20 scroll-mt-24 bg-gray-50">
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">接続例</h2>
              <div className="flex justify-center">
                <div className="w-20 h-1 rounded" style={{ backgroundColor: "#22c55e" }} />
              </div>
            </div>
            ...
            <div className="max-w-7xl mx-auto space-y-20">
              ...
              <div>
                ...
                <div className="bg-white rounded-2xl p-8 shadow-lg">
                  <div className="flex justify-center">
                    <Image
                      src="/images/brands/hotone/verbera/connection_1.png"
              ...
              <div>
                ...
                <div className="bg-white rounded-2xl p-8 shadow-lg">
                  <div className="flex justify-center">
                    <Image
                      src="/images/brands/hotone/verbera/connection_2.png"
        ...
        <section id="software" className="py-20 scroll-mt-24 bg-white">
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">ソフトウェア</h2>
              <div className="flex justify-center">
                <div className="w-20 h-1 rounded-full bg-gradient-to-r from-blue-500 to-purple-600" />
              </div>
            </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
                ...
                <div className="order-2 lg:order-1">
                  <div className="relative w-full aspect-[4/3]">
                    <Image
                      src="/images/brands/hotone/verbera/software.jpg"
                      alt="Neon Collector Software on Laptop"
                      fill
                      className="rounded-xl shadow-2xl object-cover"
                      loading="lazy"
                      sizes="(max-width: 1024px) 100vw, 50vw"
                ...
                <div className="order-1 lg:order-2 space-y-6">
                  ...
                  <div className="flex gap-4 pt-4">
                    ...
                    >
                      <Button
                        className="px-6 py-3 text-white font-medium rounded-lg flex items-center gap-2 hover:opacity-90 transition-opacity"
