...
export default function PulzeLunaPage() {
  ...
  const handleManualDownload = () => {
    downloadManual("hotone", "pulze-luna")
  }
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative w-full h-[600px] overflow-hidden">
        <Image
          src="/images/brands/hotone/PULZE_luna/hero.jpg"
          alt="Pulze Luna"
          fill
          ...
          <div className="bg-white/70 backdrop-blur-md p-6 rounded-xl shadow-2xl border border-white/30 w-96">
            ...
            <div className="space-y-4 text-gray-900">
              <div className="border-b border-gray-200 pb-3">
                ...
                <p className="text-2xl font-bold text-gray-900">Pulze Luna</p>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="space-y-6">
              <div className="rounded-2xl overflow-hidden">
                <Image
                  src="/images/brands/hotone/PULZE_luna/intro.jpg"
                  alt="Pulze Luna"
                  width={800}
                  height={600}
          ...
          <div className="space-y-20">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="rounded-xl overflow-hidden">
                <Image
                  src="/images/brands/hotone/PULZE_luna/concept_01.jpg"
                  alt="Concept 1"
                  width={600}
                  height={400}
                  className="w-full h-auto"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
              <div className="rounded-xl overflow-hidden flex justify-center">
                <Image
                  src="/images/brands/hotone/PULZE_luna/concept_02.png"
                  alt="CDCM HD + F.I.R.E."
                  width={500}
                  height={200}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="rounded-xl overflow-hidden">
                <Image
                  src="/images/brands/hotone/PULZE_luna/concept_03.jpg"
                  alt="Concept 3"
                  width={600}
                  height={400}
                  className="w-full h-auto"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="rounded-xl overflow-hidden">
                <Image
                  src="/images/brands/hotone/PULZE_luna/concept_04.jpg"
                  alt="Space+"
                  width={600}
                  height={400}
                  className="w-full h-auto"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
              <div className="rounded-xl overflow-hidden">
                <Image
                  src="/images/brands/hotone/PULZE_luna/concept_05.gif"
                  alt="Touch Screen"
                  width={600}
                  height={400}
                  className="w-full h-auto"
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
            ...
            <div className="bg-gray-100 rounded-2xl overflow-hidden">
              ...
              <div className="p-4">
                <Image
                  src="/images/brands/hotone/PULZE_luna/function_01.jpg"
                  alt="豊富な音色"
                  width={500}
                  height={300}
            ...
            <div className="bg-gray-100 rounded-2xl overflow-hidden">
              ...
              <div className="p-4">
                <Image
                  src="/images/brands/hotone/PULZE_luna/function_02.gif"
                  alt="自由なコンビネーション"
                  width={500}
                  height={100}
            ...
            <div className="bg-gray-100 rounded-2xl overflow-hidden">
              ...
              <div className="p-4">
                <Image
                  src="/images/brands/hotone/PULZE_luna/function_03.gif"
                  alt="自分好みにカスタム"
                  width={500}
                  height={300}
                  className="w-full h-auto rounded-lg mb-4"
            ...
            <div className="bg-gray-100 rounded-2xl overflow-hidden">
              ...
              <div className="p-4">
                <Image
                  src="/images/brands/hotone/PULZE_luna/function_04.jpg"
                  alt="ひらめきを刺激して"
                  width={500}
                  height={300}
                  className="w-full h-auto rounded-lg mb-4"
            ...
            <div className="bg-gray-100 rounded-2xl overflow-hidden">
              ...
              <div className="p-4">
                <Image
                  src="/images/brands/hotone/PULZE_luna/function_05.jpg"
            ...
            <div className="bg-gray-100 rounded-2xl overflow-hidden">
              ...
              <div className="p-4">
                <Image
                  src="/images/brands/hotone/PULZE_luna/function_06.png"
                  alt="自分の作品を共有できる"
                  width={500}
                  height={300}
                  className="w-full h-auto rounded-lg mb-4"
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="max-w-4xl mx-auto space-y-12">
            ...
            <div className="flex justify-center">
              <Image
                src="/images/brands/hotone/PULZE_luna/control_01.png"
                alt="Pulze Luna Front View"
                width={800}
                height={400}
            ...
            <div className="flex justify-center">
              <Image
                src="/images/brands/hotone/PULZE_luna/control_02.png"
                alt="Pulze Luna Back View"
                width={800}
                height={400}
                className="w-full h-auto max-w-3xl"
              />
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="max-w-5xl mx-auto space-y-16">
            ...
            <div className="space-y-6">
              ...
              <div className="flex justify-center">
                <Image
                  src="/images/brands/hotone/PULZE_luna/connection_01.png"
            ...
            <div className="space-y-6">
              ...
              <div className="flex justify-center">
                <Image
                  src="/images/brands/hotone/PULZE_luna/connection_02.png"
                  alt="Bluetooth接続"
                  width={900}
                  height={400}
                  className="w-full h-auto"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 items-start">
              ...
              <div className="bg-gray-300 rounded-lg overflow-hidden self-start">
                ...
                {expandedSoftware.fw140 && (
                  <div className="px-4 py-4 bg-gray-200 border-t border-gray-300 space-y-4">
                    <Image
                      src="/images/brands/hotone/PULZE_luna/software_01.png"
              ...
              <div className="bg-gray-300 rounded-lg overflow-hidden self-start">
                ...
                {expandedSoftware.fw131 && (
                  <div className="px-4 py-4 bg-gray-200 border-t border-gray-300 space-y-4">
                    <Image
                      src="/images/brands/hotone/PULZE_luna/software_02.png"
              ...
              <div className="bg-gray-300 rounded-lg overflow-hidden self-start">
                ...
                {expandedSoftware.fw120 && (
                  <div className="px-4 py-4 bg-gray-200 border-t border-gray-300 space-y-4">
                    <Image
                      src="/images/brands/hotone/PULZE_luna/software_03.png"
              ...
              <div className="bg-gray-300 rounded-lg overflow-hidden self-start">
                ...
                {expandedSoftware.mobile110 && (
                  <div className="px-4 py-4 bg-gray-200 border-t border-gray-300 space-y-4">
                    <Image
                      src="/images/brands/hotone/PULZE_luna/software_06.jpg"
              ...
              <div className="bg-gray-300 rounded-lg overflow-hidden self-start">
                ...
                {expandedSoftware.fw108 && (
                  <div className="px-4 py-4 bg-gray-200 border-t border-gray-300 space-y-4">
                    <Image
                      src="/images/brands/hotone/PULZE_luna/software_08.jpg"
