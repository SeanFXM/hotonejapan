...
export default function BinaryModPage() {
  ...
  const handleManualDownload = () => {
    downloadManual("hotone", "binary-mod")
  }
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative w-full h-[600px] overflow-hidden">
        <Image
          src="/images/brands/hotone/BINARY_MOD/hero.jpg"
          alt="BINARY MOD"
          fill
          ...
          <div className="bg-white/70 backdrop-blur-md p-6 rounded-xl shadow-2xl border border-white/30 w-96">
            ...
            <div className="space-y-4 text-gray-900">
              <div className="border-b border-gray-200 pb-3">
                ...
                <p className="text-2xl font-bold text-gray-900">BINARY MOD</p>
              </div>

              <div className="border-b border-gray-200 pb-3">
                <p className="text-xs text-gray-500 mb-1">概要：</p>
                <p className="text-base text-gray-900">モジュレーション・エフェクター</p>
              </div>
              ...
              <div className="pt-2">
                ...
                <p className="text-sm font-mono text-gray-700">6959473910047</p>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="space-y-6">
              <div className="rounded-2xl overflow-hidden shadow-2xl">
                <Image
                  src="/images/brands/hotone/BINARY_MOD/intro.jpg"
                  alt="Binary Mod"
                  width={600}
                  height={400}
              ...
              <div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <p className="text-gray-700 text-sm">エクスプレッション機能：E.LEVEL、A、B、DEPTH、RATE全てのコントロールがリアルタイムのコントロールが可能</p>
                  </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                ...
                <div className="aspect-video bg-black rounded-2xl overflow-hidden shadow-2xl">
                  <iframe
                    width="100%"
                    height="100%"
                    src="https://www.youtube.com/embed/AEUhjcWim64"
                    title="Hotone Binary MOD"
                    frameBorder="0"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="aspect-video bg-black rounded-2xl overflow-hidden shadow-2xl">
                  <iframe
                    width="100%"
                    height="100%"
                    src="https://www.youtube.com/embed/7iGybNUBxa0"
                    title="BINARY MOD Demo 2"
                    frameBorder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                    allowFullScreen
                    className="w-full h-full"
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="aspect-video bg-black rounded-2xl overflow-hidden shadow-2xl">
                  <iframe
                    width="100%"
                    height="100%"
                    src="https://www.youtube.com/embed/-tNAUuGDs08"
                    title="BINARY MOD Demo 3"
                    frameBorder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                    allowFullScreen
                    className="w-full h-full"
          ...
          <div className="container mx-auto px-6">
            ...
            <div className="max-w-4xl mx-auto space-y-12">
              <div className="flex justify-center">
                <Image
                  src="/images/brands/hotone/BINARY_MOD/control_01.png"
                  alt="BINARY MOD Top Panel"
                  width={800}
                  height={400}
              ...
              <div className="flex justify-center">
                <Image
                  src="/images/brands/hotone/BINARY_MOD/control_02.png"
                  alt="BINARY MOD Back Panel"
                  width={800}
                  height={400}
                  className="rounded-lg w-full"
                />
            ...
            <div className="max-w-5xl mx-auto">
              <div className="bg-gray-100 rounded-xl p-8">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
                  ...
                  <div>
                    <Image
                      src="/images/brands/hotone/BINARY_MOD/software_01.jpg"
                      alt="Binary Editor"
                      width={600}
                      height={400}
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-16 gap-y-8">
                  ...
                  <div className="space-y-8">
                    ...
                    <div>
                      ...
                      <div className="space-y-2">
                        <p className="text-gray-700 text-sm">搭載エフェクト数：24</p>
