  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative w-full h-[600px] overflow-hidden">
        <Image
          src="/images/brands/hotone/Mojo_Diamond/hero.jpg"
          alt="Mojo Diamond"
          fill
          ...
          <div className="bg-white/70 backdrop-blur-md p-6 rounded-xl shadow-2xl border border-white/30 w-96">
            ...
            <div className="space-y-4 text-gray-900">
              <div className="border-b border-gray-200 pb-3">
                ...
                <p className="text-2xl font-bold text-gray-900">Mojo Diamond</p>
              </div>
              ...
              <div className="pt-2">
                ...
                <p className="text-sm font-mono text-gray-700">6959473901052</p>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <div className="rounded-2xl overflow-hidden">
                <Image
                  src="/images/brands/hotone/Mojo_Diamond/intro.jpg"
                  alt="Mojo Diamond"
                  width={600}
                  height={400}
            ...
            <div className="space-y-6">
              ...
              <p className="text-gray-700 leading-relaxed">
                手のひらサイズのアンプヘッドHOTONE Nano Legacy シリーズ に新たなモデルが加わりました。それはビンテージ・ツイード・サウンドを彷彿させるMojo Diamond。この5W 出力のアンプ、リアルサイズのSP キャビネットにつなぐと音がデカい。ツイード・コンボもぶっ飛ぶビンテージトーンを叩き出してくれます。「ちょっとセッションに！」という際の必需品です。
              </p>
              <p className="text-gray-700 leading-relaxed">
              ...
              <ul className="space-y-3">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-gray-700">アナログ回路によるクラスAB / 5W出力</span>
                </li>
                <li className="flex items-start gap-3">
                  <svg className="w-5 h-5 text-purple-600 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                  </svg>
                  <span className="text-gray-700">トーン・シェーピング用3バンドEQ</span>
                </li>
                <li className="flex items-start gap-3">
                  <svg className="w-5 h-5 text-purple-600 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
          ...
          <div className="max-w-4xl mx-auto">
            <div className="aspect-video rounded-2xl overflow-hidden shadow-2xl">
              <iframe
                width="100%"
                height="100%"
                src="https://www.youtube.com/embed/V5PYc4Gkv8M"
                title="Mojo Diamond Demo"
                frameBorder="0"
          ...
          <div className="max-w-md mx-auto">
            <div className="bg-white rounded-xl shadow-md p-5">
              <div className="flex items-center gap-3 mb-3">
                ...
                <p className="font-medium text-gray-900 text-sm">Mojo Diamond Overview Demo</p>
              </div>
              <audio controls className="w-full h-10">
                <source src="/images/brands/hotone/Mojo_Diamond/sound_01.mp3" type="audio/mpeg" />
              </audio>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-5xl mx-auto">
            <div className="bg-white rounded-2xl p-8">
              <div className="space-y-8">
                <div>
                  <Image
                    src="/images/brands/hotone/Mojo_Diamond/control_01.png"
                    alt="Mojo Diamond Top Panel"
                    width={1000}
                    height={400}
                ...
                <div className="border-t border-gray-200 pt-8">
                  <Image
                    src="/images/brands/hotone/Mojo_Diamond/control_02.png"
                    alt="Mojo Diamond Back Panel"
                    width={1000}
                    height={400}
                    className="w-full h-auto rounded-lg"
                  />
