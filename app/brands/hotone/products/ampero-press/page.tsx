...
type Section = "demo" | "manual" | "specs"
...
export default function AmperoPressPage() {
  ...
  const handleManualDownload = () => {
    downloadManual("hotone", "ampero-press")
  }
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative w-full h-[600px] overflow-hidden">
        <Image
          src="/images/brands/hotone/Ampero_Press/hero.jpg"
          alt="AMPERO PRESS"
          fill
          ...
          <div className="bg-white/70 backdrop-blur-md p-6 rounded-xl shadow-2xl border border-white/30 w-96">
            ...
            <div className="space-y-4 text-gray-900">
              <div className="border-b border-gray-200 pb-3">
                ...
                <p className="text-2xl font-bold text-gray-900">AMPERO PRESS</p>
              </div>

              <div className="border-b border-gray-200 pb-3">
                <p className="text-xs text-gray-500 mb-1">概要：</p>
                <p className="text-base text-gray-900">パッシブVol / EXPペダル</p>
              </div>
              ...
              <div className="pt-2">
                ...
                <p className="text-sm font-mono text-gray-700">6959473904077</p>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="space-y-8">
              <div>
                <Image
                  src="/images/brands/hotone/Ampero_Press/intro_01.gif"
                  alt="AMPERO PRESS"
                  width={500}
                  height={400}
            ...
            <div className="space-y-6">
              <p className="text-gray-700 leading-relaxed">
                AMPERO PRESSは、AMPEROシリーズの外部エクスプレション・ペダルとして、多くのコントロール機能を外部からコントロールできるのはもちろん、独立したボリューム・ペダル（パッシブ）としても使用可能です。
              </p>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-3">
                  <span className="text-green-500 mt-0.5">✓</span>
                  <p className="text-gray-700 text-sm">
                    <strong>EXP OUT（エクスプレッション出力）</strong>：エクスプレッション専用の1/4&quot; TRSジャックです。外部機器のEXP INにTRSケーブルで接続します。接続する機器の推奨EXPインピーダンスを確認してください。VolとEXPが同時に使用できます。
                  </p>
                </div>
                <div className="flex items-start gap-3">
                  <span className="text-green-500 mt-0.5">✓</span>
              ...
              <div className="mt-8">
                <Image
                  src="/images/brands/hotone/Ampero_Press/intro_02.png"
                  alt="AMPERO PRESS Connection Diagram"
                  width={600}
                  height={300}
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-black rounded-2xl overflow-hidden aspect-video shadow-2xl">
              <iframe
                width="100%"
                height="100%"
                src="https://www.youtube.com/embed/aN8jaYB3tps"
                title="AMPERO PRESS Demo Video"
                frameBorder="0"
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2">
                ...
                <div className="p-6 border-b lg:border-b-0 lg:border-r border-gray-200">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="py-2 border-b border-gray-100">
                      <span className="text-gray-700">EXP エクスプレッション：10kΩ</span>
                    </div>
                  </div>
                </div>
