...
export default function OmniACPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative w-full h-[600px] overflow-hidden">
        <Image
          src="/images/brands/hotone/OMNI_AC/hero.jpg"
          alt="OMNI AC"
          fill
          ...
          <div className="bg-white/70 backdrop-blur-md p-6 rounded-xl shadow-2xl border border-white/30 w-96">
            ...
            <div className="space-y-4 text-gray-900">
              <div className="border-b border-gray-200 pb-3">
                ...
                <p className="text-2xl font-bold text-gray-900">OMNI AC</p>
              </div>

              <div className="border-b border-gray-200 pb-3">
                <p className="text-xs text-gray-500 mb-1">概要：</p>
                <p className="text-base text-gray-900">アコースティック・シミュレーター</p>
              </div>
              ...
              <div className="pt-2">
                ...
                <p className="text-sm font-mono text-gray-700">6959473909058</p>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
              スチール、ナイロン、ベースなど<br />15種類のエミュレーションを搭載
            </h2>
            ...
            <div className="space-y-6">
              ...
              <div className="aspect-video bg-black rounded-2xl overflow-hidden shadow-2xl">
                <iframe
                  width="100%"
                  height="100%"
                  src="https://www.youtube.com/embed/51OjVfnTRd4"
                  title="Hotone Omni AC - Introduction"
                  frameBorder="0"
              ...
              <div className="bg-gray-50 rounded-xl p-6 space-y-4">
                ...
                <div className="space-y-3">
                  <button className="w-full text-left px-4 py-3 bg-white rounded-lg hover:bg-gray-100 transition-colors flex items-center gap-3 border border-gray-200">
                    ...
                    <span className="text-gray-900">OMNI IR 製品情報</span>
                  </button>
                  <button className="w-full text-left px-4 py-3 bg-white rounded-lg hover:bg-gray-100 transition-colors flex items-center gap-3 border border-gray-200">
                    <div className="w-2 h-2 rounded-full hotone-dot" />
              ...
              <div>
                <div className="prose max-w-none mb-8">
                  <p className="text-gray-700 leading-relaxed mb-4">
                    Omni ACは、HOTONE独自のCDCMモデリング・テクノロジーを採用したアコースティック・シミュレーターです。特に、エレアコ信号から本機を通して録音（再生）する場合に、アコースティック・ギターをマイキングしたサウンドに仕上げてくれます。
                  </p>

                  <p className="text-gray-700 leading-relaxed mb-4">
                    また、内部のアナログ回路は9V入力電源を昇圧し、+8dBuを超える信号を入力できるように設計しました。これにより、余裕があり高いダイナミクスのアコースティック・サウンドが得られます。24bitの高品位サウンドはフルデジタルEQによるサウンドシェーピングが可能で、それぞれをメモリーすることもできます。このエディティングはフリーソフトによるPCやMacでのエディティングもサポートしています。
                  </p>

                  <p className="text-gray-700 leading-relaxed mb-4">
                    有機ELスクリーンは、小型ながらエディティング、プログラムリコール、フットスイッチ機能の設定が非常に見やすく、スピーディーな操作が実行できます。
                  </p>

                  <p className="text-gray-600 leading-relaxed mb-6 text-sm">
                    ※ CDCMモデリング・テクノロジーに関しては、XTOMP 製品情報をご覧ください。
                  </p>
                </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    ...
                    <p className="text-gray-700 text-sm">コンパクトサイズのアコースティック・シミュレーター・ペダル</p>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <p className="text-gray-700 text-sm">スチール、ナイロン、ベースなど15xハイクオリティーなアコースティックギターのエミュレーションサウンド</p>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <p className="text-gray-700 text-sm">USBジャック：ファームウェアアップデート、エディティングソフト（フリー）に使用</p>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <p className="text-gray-700 text-sm">15プリセットロケーション</p>
                  </div>
            ...
            <div className="max-w-4xl mx-auto">
              <div className="aspect-video bg-black rounded-2xl overflow-hidden shadow-2xl">
                <iframe
                  width="100%"
                  height="100%"
                  src="https://www.youtube.com/embed/YyQ6zGjXmEM"
                  title="OMNI AC Demo"
                  frameBorder="0"
                  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                  allowFullScreen
          ...
          <div className="container mx-auto px-6">
            ...
            <div className="max-w-4xl mx-auto space-y-12">
              <div className="flex justify-center">
                <Image
                  src="/images/brands/hotone/OMNI_AC/control_01.png"
                  alt="OMNI AC Top Panel"
                  width={800}
                  height={400}
              ...
              <div className="flex justify-center">
                <Image
                  src="/images/brands/hotone/OMNI_AC/control_02.png"
                  alt="OMNI AC Back Panel"
                  width={800}
                  height={400}
                  className="rounded-lg w-full"
                />
            ...
            <div className="max-w-5xl mx-auto">
              <div className="bg-gray-200 rounded-2xl p-8">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
                  ...
                  <div>
                    <Image
                      src="/images/brands/hotone/OMNI_AC/software_01.jpg"
                      alt="OMNI AC Editor"
                      width={600}
                      height={400}
