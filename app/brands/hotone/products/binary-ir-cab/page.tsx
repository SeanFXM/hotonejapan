...
export default function BinaryIrCabPage() {
  ...
  const handleManualDownload = () => {
    downloadManual("hotone", "binary-ir-cab")
  }
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative w-full h-[600px] overflow-hidden">
        <Image
          src="/images/brands/hotone/BINARY_IR_CAB/hero.jpg"
          alt="BINARY IR CAB"
          fill
          ...
          <div className="bg-white/70 backdrop-blur-md p-6 rounded-xl shadow-2xl border border-white/30 w-96">
            ...
            <div className="space-y-4 text-gray-900">
              <div className="border-b border-gray-200 pb-3">
                ...
                <p className="text-2xl font-bold text-gray-900">BINARY IR CAB</p>
              </div>
              ...
              <div className="pt-2">
                ...
                <p className="text-sm font-mono text-gray-700">6959473910023</p>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="space-y-6">
              <div className="rounded-2xl overflow-hidden shadow-2xl">
                <Image
                  src="/images/brands/hotone/BINARY_IR_CAB/intro.jpg"
                  alt="Binary IR Cab"
                  width={600}
                  height={400}
              ...
              <div>
                <div className="prose max-w-none mb-8">
                  ...
                  <p className="text-gray-700 leading-relaxed mb-6">
                    Binary IR CABは、リアルなギターサウンドをラインで再生するために、キャビネット、マイク、パワーアンプのセットアップの再現をするキャビネット・シミュレーターです。マイクロフォンのエミュレーションには、有名な10種のマイクロフォンに加えて録音ポジションの設定も3-Dで可能にしました。加えて、8種のパワーアンプとプレゼンスコントロール、ルームエミュレーションも備えています。
                  </p>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <p className="text-gray-700 text-sm">110dB S/N比を実現した24-bit 48kHz A/D/A変換</p>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <p className="text-gray-700 text-sm">100種類のIRキャビネット・シミュレーション</p>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <p className="text-gray-700 text-sm">3D（X,Y,Z）のマイク・ポジショニング設定＆ルーム・シミュレーション</p>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <p className="text-gray-700 text-sm">8種のパワーアンプ・シミュレーション</p>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <p className="text-gray-700 text-sm">AUX IN & ヘッドホン出力</p>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <p className="text-gray-700 text-sm">3rd パーティのIRファイル使用可能</p>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <p className="text-gray-700 text-sm">100 プリセット</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                ...
                <div className="aspect-video bg-black rounded-2xl overflow-hidden shadow-2xl">
                  <iframe
                    width="100%"
                    height="100%"
                    src="https://www.youtube.com/embed/fCATsYPOtiM"
                    title="Hotone Binary IR CAB"
                    frameBorder="0"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="aspect-video bg-black rounded-2xl overflow-hidden shadow-2xl">
                  <iframe
                    width="100%"
                    height="100%"
                    src="https://www.youtube.com/embed/GGC_dPA_3ew"
                    title="BINARY IR CAB Demo 2"
                    frameBorder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                    allowFullScreen
                    className="w-full h-full"
          ...
          <div className="container mx-auto px-6">
            ...
            <div className="max-w-4xl mx-auto space-y-12">
              <div className="flex justify-center">
                <Image
                  src="/images/brands/hotone/BINARY_IR_CAB/control_01.png"
                  alt="BINARY IR CAB Top Panel"
                  width={800}
                  height={400}
              ...
              <div className="flex justify-center">
                <Image
                  src="/images/brands/hotone/BINARY_IR_CAB/control_02.png"
                  alt="BINARY IR CAB Back Panel"
                  width={800}
                  height={400}
                  className="rounded-lg w-full"
                />
            ...
            <div className="max-w-5xl mx-auto">
              <div className="bg-gray-100 rounded-xl p-8">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
                  ...
                  <div>
                    <Image
                      src="/images/brands/hotone/BINARY_IR_CAB/software_01.jpg"
                      alt="Binary Editor"
                      width={600}
                      height={400}
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-16 gap-y-8">
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-gray-700 text-sm">出力：1/4インチ・モノラル・フォーン端子</p>
                      <p className="text-gray-700 text-sm">出力インピーダンス：100 Ohms</p>
                      <p className="text-gray-700 text-sm">AUX入力：1/4インチ・ステレオ・フォーン端子</p>
                      <p className="text-gray-700 text-sm">ヘッドホン出力：1/4インチ・ステレオ・フォーン端子</p>
                  ...
                  <div className="space-y-8">
                    ...
                    <div>
                      ...
                      <div className="space-y-2">
                        <p className="text-gray-700 text-sm">搭載エフェクト数：100 cab / 8 power amp types / 10 mic types</p>
                        <p className="text-gray-700 text-sm">プリセット数：2 BANK x 5</p>
                        <p className="text-gray-700 text-sm">プロセッシング：24bit / 48kHz</p>
